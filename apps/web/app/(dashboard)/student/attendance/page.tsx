...
export default async function StudentAttendancePage() {
  ...
  // approved-absences endpoint — this student's own RLS grants no direct
  // read of absence_requests, see docs/audits/shared-helpers-call-sites.md
  // §1.3, which is why this page previously always showed "Excused: 0").
  ...
  const attendanceInput = student
    ? await fetchAttendanceData(supabase, student.id, attendanceRange)
